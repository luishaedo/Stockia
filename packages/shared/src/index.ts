...
export const ErrorCodes = {
    ...
    QUICK_CURVES_READ_FAILED: 'QUICK_CURVES_READ_FAILED',
    QUICK_CURVES_WRITE_FAILED: 'QUICK_CURVES_WRITE_FAILED',
    QUICK_CURVES_SCHEMA_NOT_READY: 'QUICK_CURVES_SCHEMA_NOT_READY',
} as const;
